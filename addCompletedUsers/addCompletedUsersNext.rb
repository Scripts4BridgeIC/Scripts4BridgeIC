...
csv_file = '/Users/swasilewski/Desktop/Bridge/RubyScripts/thrive/ThriveChunk1.csv'
    ...
    loop do
      ...
      json["enrollments"].each_with_index do |arrayEnroll,i|
        ...
        if json["enrollments"][i]["links"]["learner"]["id"] == row['bridgeuserid']
          ...
          puts "user #{json["enrollments"][i]["links"]["learner"]["id"]} - course #{row['courseid']}\n#{payload}"
