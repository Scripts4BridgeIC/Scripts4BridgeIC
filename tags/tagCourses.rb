# Script to add tags to a course based on a CSV
# file. 
...
CSV.foreach(csv_file, {:headers => true}) do |row|
    ...
    payload = {"tags"=>["name" => "#{row["tagName"]}","context_id"=>"#{row["course_id"]}", "context_type"=>"course_template"]}
